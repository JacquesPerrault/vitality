module.exports = {
        getvitalitybyrepo: getvitalitybyrepo
}

function getvitalitybyrepo(req, res) {
  console.log('=====================================');
  console.log('GET VITALITY DATA BY REPO ===========');
  console.log('=====================================');
  ...
  if (allrepos.length === 0 ) {
    ...
    res.send(200, callback + '(\'' + JSON.stringify(error) + '\')');
      ...
      var promise = new Promise(function (resolve, reject) {
        ...
        var error = {'success': false, 'message': 'Unable to retrieve repo vitality data.', 'code': 201, 'nativemessage': reason.message, 'nativecode': reason.code };
